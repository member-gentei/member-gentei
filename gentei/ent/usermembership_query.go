...
func (umq *UserMembershipQuery) GroupBy(field string, fields ...string) *UserMembershipGroupBy {
	group := &UserMembershipGroupBy{config: umq.config}
...
func (umq *UserMembershipQuery) Select(fields ...string) *UserMembershipSelect {
	...
	return &UserMembershipSelect{UserMembershipQuery: umq}
}
...
func (umq *UserMembershipQuery) sqlAll(ctx context.Context) ([]*UserMembership, error) {
	var (
	...
	if query := umq.withRoles; query != nil {
		...
		ids := make(map[int]*UserMembership, len(nodes))
		...
		var (
			edgeids []uint64
			edges   = make(map[uint64][]*UserMembership)
		)
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(usermembership.RolesPrimaryKey[0], fks...))
			},
		...
		if err := sqlgraph.QueryEdges(ctx, umq.driver, _spec); err != nil {
...
func (umgb *UserMembershipGroupBy) ScanX(ctx context.Context, v interface{}) {
...
func (umgb *UserMembershipGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(umgb.fields) > 1 {
		return nil, errors.New("ent: UserMembershipGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := umgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (umgb *UserMembershipGroupBy) StringsX(ctx context.Context) []string {
...
// It is only allowed when executing a group-by query with one field.
func (umgb *UserMembershipGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{usermembership.Label}
	default:
		err = fmt.Errorf("ent: UserMembershipGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (umgb *UserMembershipGroupBy) StringX(ctx context.Context) string {
...
// It is only allowed when executing a group-by query with one field.
func (umgb *UserMembershipGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(umgb.fields) > 1 {
		return nil, errors.New("ent: UserMembershipGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := umgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (umgb *UserMembershipGroupBy) IntsX(ctx context.Context) []int {
	v, err := umgb.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (umgb *UserMembershipGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{usermembership.Label}
	default:
		err = fmt.Errorf("ent: UserMembershipGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (umgb *UserMembershipGroupBy) IntX(ctx context.Context) int {
	v, err := umgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (umgb *UserMembershipGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(umgb.fields) > 1 {
		return nil, errors.New("ent: UserMembershipGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := umgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (umgb *UserMembershipGroupBy) Float64sX(ctx context.Context) []float64 {
...
// It is only allowed when executing a group-by query with one field.
func (umgb *UserMembershipGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{usermembership.Label}
	default:
		err = fmt.Errorf("ent: UserMembershipGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (umgb *UserMembershipGroupBy) Float64X(ctx context.Context) float64 {
...
// It is only allowed when executing a group-by query with one field.
func (umgb *UserMembershipGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(umgb.fields) > 1 {
		return nil, errors.New("ent: UserMembershipGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := umgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (umgb *UserMembershipGroupBy) BoolsX(ctx context.Context) []bool {
...
// It is only allowed when executing a group-by query with one field.
func (umgb *UserMembershipGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{usermembership.Label}
	default:
		err = fmt.Errorf("ent: UserMembershipGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (umgb *UserMembershipGroupBy) BoolX(ctx context.Context) bool {
	v, err := umgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
// ScanX is like Scan, but panics if an error occurs.
func (ums *UserMembershipSelect) ScanX(ctx context.Context, v interface{}) {
...
func (ums *UserMembershipSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ums.fields) > 1 {
		return nil, errors.New("ent: UserMembershipSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ums.Scan(ctx, &v); err != nil {
		return nil, err
...
// StringsX is like Strings, but panics if an error occurs.
func (ums *UserMembershipSelect) StringsX(ctx context.Context) []string {
...
func (ums *UserMembershipSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{usermembership.Label}
	default:
		err = fmt.Errorf("ent: UserMembershipSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (ums *UserMembershipSelect) StringX(ctx context.Context) string {
...
func (ums *UserMembershipSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ums.fields) > 1 {
		return nil, errors.New("ent: UserMembershipSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ums.Scan(ctx, &v); err != nil {
		return nil, err
...
// IntsX is like Ints, but panics if an error occurs.
func (ums *UserMembershipSelect) IntsX(ctx context.Context) []int {
	v, err := ums.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
func (ums *UserMembershipSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{usermembership.Label}
	default:
		err = fmt.Errorf("ent: UserMembershipSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (ums *UserMembershipSelect) IntX(ctx context.Context) int {
	v, err := ums.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (ums *UserMembershipSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ums.fields) > 1 {
		return nil, errors.New("ent: UserMembershipSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ums.Scan(ctx, &v); err != nil {
		return nil, err
...
// Float64sX is like Float64s, but panics if an error occurs.
func (ums *UserMembershipSelect) Float64sX(ctx context.Context) []float64 {
...
func (ums *UserMembershipSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{usermembership.Label}
	default:
		err = fmt.Errorf("ent: UserMembershipSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (ums *UserMembershipSelect) Float64X(ctx context.Context) float64 {
...
func (ums *UserMembershipSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ums.fields) > 1 {
		return nil, errors.New("ent: UserMembershipSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ums.Scan(ctx, &v); err != nil {
		return nil, err
...
// BoolsX is like Bools, but panics if an error occurs.
func (ums *UserMembershipSelect) BoolsX(ctx context.Context) []bool {
	v, err := ums.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
func (ums *UserMembershipSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{usermembership.Label}
	default:
		err = fmt.Errorf("ent: UserMembershipSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (ums *UserMembershipSelect) BoolX(ctx context.Context) bool {
	v, err := ums.Bool(ctx)
	if err != nil {
		panic(err)
	}
