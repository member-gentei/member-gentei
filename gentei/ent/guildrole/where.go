...
func And(predicates ...predicate.GuildRole) predicate.GuildRole {
	return predicate.GuildRole(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.GuildRole) predicate.GuildRole {
	return predicate.GuildRole(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.GuildRole) predicate.GuildRole {
	return predicate.GuildRole(sql.NotPredicates(p))
}
